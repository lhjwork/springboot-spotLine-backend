...
| Feature | Match Rate | Period | Documents |
|---------|:----------:|--------|-----------|
...
| Document | File |
|----------|------|
| Plan | [backend-auth.plan.md](./backend-auth/backend-auth.plan.md) |
| Design | [backend-auth.design.md](./backend-auth/backend-auth.design.md) |

> Analysis/Report는 admin-spotLine 레포 archive에 보관

### social-interactions-backend (소셜 기능 Backend — Like/Save/Follow/Profile/Replication API)

| Document | File |
|----------|------|
| Plan | [social-interactions-backend.plan.md](./social-interactions-backend/social-interactions-backend.plan.md) |
